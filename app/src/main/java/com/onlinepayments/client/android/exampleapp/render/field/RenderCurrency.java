    ...
    public View renderField(
        ...
        if (inputDataPersister == null) {
            throw new InvalidParameterException(
                "Error rendering currency, inputDataPersister may not be null");
        }
        if (rowView == null) {
        ...
        if (paymentContext == null) {
            throw new InvalidParameterException(
                "Error rendering currency, paymentContext may not be null");
        }
        ...
        currencySymbol.setText(Objects.requireNonNull(paymentContext.getAmountOfMoney())
            .getCurrencyCode());
        ...
        integerPart.addTextChangedListener(new FieldInputTextWatcherCurrency(inputDataPersister,
            field.getId(),
            decimalPart,
            true
        ));
        decimalPart.addTextChangedListener(new FieldInputTextWatcherCurrency(inputDataPersister,
            field.getId(),
            integerPart,
            false
        ));
        ...
        LinearLayout.LayoutParams params0 =
            new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, 0f);
