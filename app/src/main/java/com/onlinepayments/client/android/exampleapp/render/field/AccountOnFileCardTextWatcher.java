...
public class AccountOnFileCardTextWatcher extends FieldInputTextWatcher {
    ...
    public AccountOnFileCardTextWatcher(
        ...
        if (iinLookupTextWatcher == null) {
            throw new InvalidParameterException(
                "Error creating AccountOnFileCardTextWatcher, iinLookupTextWatcher may not be null");
        }
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (!s.toString().isEmpty() && !s.toString().equals(accountOnFileValue)) {
