...
public class StringProvider {
	...
	public String getValidationMessage(String errorMessageId) {
		...
		if (errorMessageId == null) {
			throw new InvalidParameterException("Error retrieving validation message, errorMessageId may not be null");
		}
	...
	public String getCoBrandNotificationText(String coBrandMessageId) {
		if (coBrandMessageId == null) {
			throw new InvalidParameterException("Error retrieving coBrand description, paymentProductId may not be null");
		}
	...
	public String retrieveString(String identifier) {
		...
		if (identifier == null) {
			throw new InvalidParameterException("Error translating string, identifier may not be null");
		}
		if (context == null) {
